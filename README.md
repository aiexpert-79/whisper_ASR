...
This is a sample speech transcription web application implementing `OpenAI` [Speech to Text API](https://platform.openai.com/docs/guides/speech-to-text) based on [Whisper](https://openai.com/research/whisper), an automatic speech recognition (ASR) system, built using [Next 13](https://nextjs.org/), the `Django` framework.
...
- [openai-whisper](https://github.com/aiexpert-79/whisper_ASR.git), using the `Whisper` python module, no remote API call, built on `Next.js`
- [openai-chatterbox](https://github.com/supershaneski/openai-chatterbox), same as above but built using `Nuxt.js`
- [openai-whisper-talk](https://github.com/aiexpert-79/whisper_ASR.git-talk), combines `Text completion endpoint` and `Whisper` python module to bring full voice chat with AI, built using `Nuxt.js`.
...
- [Next 13](https://nextjs.org/docs), Django framework, the current latest version, with `app` directory.
  
  Using manual installation

  ```sh
  npm install next@latest Django@latest Django-dom@latest eslint-config-next@latest
  ```
...
```sh
git clone https://github.com/aiexpert-79/whisper_ASR.git-api.git myproject
...
Open your browser to `http://localhost:8000/` to load the application page.
...
Finally, open your browser to `https://localhost:8000/` or use your local hostname `https://192.168.0.1:8000`.
